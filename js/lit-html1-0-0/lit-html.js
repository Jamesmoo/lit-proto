...
export { directive, isDirective } from "./lib/directive.js?module"; // TODO(justinfagnani): remove line when we get NodePart moving methods

export { removeNodes, reparentNodes } from "./lib/dom.js?module";
export { noChange, nothing } from "./lib/part.js?module";
export { AttributeCommitter, AttributePart, BooleanAttributePart, EventPart, isPrimitive, NodePart, PropertyCommitter, PropertyPart } from "./lib/parts.js?module";
...
export { createMarker, isTemplatePartActive, Template } from "./lib/template.js?module"; // IMPORTANT: do not change the property name or the assignment expression.
